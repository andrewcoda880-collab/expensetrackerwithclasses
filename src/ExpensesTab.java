...
>>>>>>> Kyle-Branch
    ...
    private void addExpense() {
        ...
        if (name.isEmpty() || amountText.isEmpty() || category == null || category.isEmpty()) {
...
>>>>>>> Kyle-Branch
            ...
            // Refresh the AllExpensesTab if it exists
            if (allExpensesTab != null) {
                allExpensesTab.refreshTable();
            }
...
>>>>>>> Kyle-Branch
    ...
    private void refreshTopExpensesTable() {
        ...
        int sortedLimit = Math.min(3, sortedExpenses.size());
    ...
    private void refreshRecentExpensesTable() {
        ...
        for (int i = expenses.size() - 1; i >= expenses.size() - recentLimit; i--) {
            if (i >= 0) {
