...
public class ExpensesTab extends JPanel implements ThemeListener {
    ...
    private JPanel createInputsPanel() {
        ...
        // ------- date --------
        // TODO: Add date feature - need to implement date picker for expense tracking
    ...
    private void refreshTopExpensesTable() {
       ...
       // Changed to show all expenses instead of limiting to 4
    ...
    // Changed to show all expenses instead of limiting to 3
